...
public class BufferPool {
	// create a data structure to maintain pages information
    ...
    public void insertTuple(TransactionId tid, int tableId, Tuple t)
    	...
    	/*
    	 * get heapfile from catalog
    	 * insert tuple using heapfile method
    	 * Mark returned pages as dirty and place them in the buffer
    	 */
    }
    ...
    public  void deleteTuple(TransactionId tid, Tuple t)
        ...
        // not necessary for lab1
    	/*
    	 * same as insert tuple but call delete method
    	 */
    }
    ...
    */
    ...
    private synchronized  void flushPage(PageId pid) throws IOException {
        // some code goes here
        // not necessary for lab1
    	// write page to disk and clear its dirty flag
    }
